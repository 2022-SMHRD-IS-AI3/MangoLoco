...
select*from COUPONS
insert into COUPONS values(1, 'aaaa', sysdate, sysdate, 1000)
insert into COUPONS values(2, 'bbbb', sysdate, sysdate, 100)
...
insert into COUPON_HISTORY values(1, 1, 'test', 1, sysdate, sysdate)
insert into COUPON_HISTORY values(2, 2, 'bbbb', 1, sysdate, sysdate)
