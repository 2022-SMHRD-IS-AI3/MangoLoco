	...
	<article id="top" class="wrapper style1">
		...
		<div class="container" style=" background-color: yellow; height: 500px; width : 1600px; position: relative;">
			...
			<div class="filterList" style = "position : absolute; transform: translate(1%, -5%); background : aqua; border: 10px solid transparent; width : 15%">
				<div class="filter">
					<a data-value="Photoshop"><img class="programs" src="images/rg/PhotoShop.png" alt="포토샵"
							style="border-radius: 20%;" />
						<div style="text-align: center; margin-top: -5px;">포토샵</div>
					</a>
					<a data-value="Affinity Photo"><img class="programs" src="images/rg/affinity photo.png"
							style="border-radius: 24%; " alt="어피니티 포토" />
						<div style="text-align: center; margin-top: -5px;">어피니티 포토</div>
					</a>
					<a data-value="Painter"><img class="programs" src="images/rg/painter.png" alt="페인터" />
						<div style="text-align: center; margin-top: -5px;">페인터</div>
					</a>
					<a data-value="Fresco"><img class="programs" src="images/rg/adobefresco.png"
							style="border-radius: 20%;" alt="프로스코" />
						<div style="text-align: center; margin-top: -5px;">프로스코</div>
					</a>
					<a data-value="Procreate"><img class="programs" src="images/rg/procreate.png"
							style="border-radius: 20%; ;" alt="프로크리에이트" />
						<div style="text-align: center; margin-top: -5px;">프로크리에이트</div>
					</a>
					<a data-value="Paintshop"><img class="programs" src="images/rg/paintshop.png" alt="페인트샵" />
						<div style="text-align: center; margin-top: -5px;">페인트샵</div>
					</a>
					<a data-value="Artweaver"><img class="programs" src="images/rg/artweaver.png" alt="아트위버" />
						<div style="text-align: center; margin-top: -5px;">아트위버</div>
					</a>
					<a data-value="Clip Studio Paint"><img class="programs" src="images/rg/clip studio paint.png"
							alt="클립스튜디오" />
						<div style="text-align: center; margin-top: -5px;">클립스튜디오</div>
					</a>
					<a data-value="PhotoScape"><img class="programs" src="images/rg/photoscape.png" alt="포토스케이프" />
						<div style="text-align: center; margin-top: -5px;">포토스케이프</div>
					</a>
					<a data-value="PixelMator"><img class="programs" src="images/rg/pixelmator.png" alt="픽셀메이터" />
						<div style="text-align: center; margin-top: -5px;">픽셀메이터</div>
					</a>
				</div>
			</div>
			...
			<div class="filterList" style="left: 20%;">
				<div class="filter">
					<a data-value="Illustrator"><img class="programs" src="images/vg/Illustrator.png" alt="일러스트레이터" />
						<div style="text-align: center; margin-top: -5px;">일러스트레이터</div>
					</a>
					<a data-value="Vectornator"><img class="programs" src="images/vg/vectornator.png" alt="벡터네이터" />
						<div style="text-align: center; margin-top: -5px;">벡터네이터</div>
					</a>
					...
					<a data-value="Gravit"><img class="programs" src="images/vg/Gravit.png" alt="그래빗" />
						<div style="text-align: center; margin-top: -5px;">그래빗</div>
					</a>
					<a data-value="Figma"><img class="programs" src="images/vg/figma.png" alt="피그마" />
						<div style="text-align: center; margin-top: -5px;">피그마</div>
					</a>
					<a data-value="Sketch"><img class="programs" src="images/vg/sketch.png" alt="스케치" />
						<div style="text-align: center; margin-top: -5px;">스케치</div>
					</a>
					<a data-value="InkScape"><img class="programs" src="images/vg/inkcape.png" alt="잉크스케이프" />
						<div style="text-align: center; margin-top: -5px;">잉크스케이프</div>
					</a>
					<a data-value="Animate"><img class="programs" src="images/vg/adobeanimate.png" alt="애니메이트" />
						<div style="text-align: center; margin-top: -5px;">애니메이트</div>
					</a>
					<a data-value="Corel DRAW"><img class="programs" src="images/vg/corel drow.png" alt="코렐드로" />
						<div style="text-align: center; margin-top: -5px;">코렐드로</div>
					</a>
					<a data-value="PaintShop"><img class="programs" src="images/vg/paintshop.png" alt="페인트샵" />
						<div style="text-align: center; margin-top: -5px;">페인트샵</div>
					</a>
				</div>
			</div>
			...
			<div class="filterList" style="left:40%;">
				<div class="filter">
					<a data-value="InDesign"><img class="programs" src="images/dp/Adobe InDesign.png" alt="인디자인" />
						<div>인디자인</div>
					</a>
					<a data-value="Canva"><img class="programs" src="images/dp/Canva.png" alt="캔바" />
						<div>캔바</div>
					</a>
					<a data-value="Snappa"><img class="programs" src="images/dp/Snappa.png" alt="Snappa" />
						<div>Snappa</div>
					</a>
					<a data-value="Lucidpress"><img class="programs" src="images/dp/Lucidpress.png" alt="Lucidpress" />
						<div>Lucidpress</div>
					</a>
					<a data-value="Venngage"><img class="programs" src="images/dp/Venngage.png" alt="Venngage" />
						<div>Venngage</div>
					</a>
					<a data-value="Visme"><img class="programs" src="images/dp/Visme.png" alt="Visme" />
						<div>Visme</div>
					</a>
					...
					<a data-value="Lightroom"><img class="programs" src="images/dp/Adobe Lightroom.png" alt="라이트룸" />
						<div>라이트룸</div>
					</a>
					<a data-value="Snapseed"><img class="programs" src="images/dp/Snapseed.png" alt="스냅시드" />
						<div>스냅시드</div>
					</a>
				</div>
			</div>
			...
			<div class="filterList" style="left: 80%;">
				<div class="filter">
					<a data-value="Autodesk"><img class="programs" src="images/rander/Autodesk.jpg" alt="오토데스크" />
						<div>오토데스크</div>
					</a>
					<a data-value="ZBrush"><img class="programs" src="images/rander/ZBrush.png" alt="Z브러시" />
						<div>Z브러시</div>
					</a>
					<a data-value="Artec"><img class="programs" src="images/rander/Artec.png" alt="아텍" />
						<div>아텍</div>
					</a>
					...
					<a data-value="Blender"><img class="programs" src="images/rander/Blender.png" alt="블렌더" />
						<div>블렌더</div>
					</a>
					<a data-value="Wings 3D"><img class="programs" src="images/rander/Wings 3D.png" alt="윙즈 3D" />
						<div>윙즈 3D</div>
					</a>
					<a data-value="Houdini"><img class="programs" src="images/rander/Houdini.png" alt="후디니" />
						<div>후디니</div>
					</a>
					...
					<a data-value="Cinema 4D"><img class="programs" src="images/rander/Cinema 4D.jfif" alt="시네마 4D" />
						<div>시네마 4D</div>
					</a>
				</div>
			</div>
		...
		<footer>
			<a href="#work" id="filterBtn" class="button scrolly"
				style="left: 50%; transform: translate(-50%, 0%);display: flex; align-items: center; justify-content: center; width: 170px;"><ion-icon
					name="filter-outline" style="font-size: 20px; "></ion-icon>&nbsp 필터링</a>
		</footer>
	</article>
		...
		<div class="container">
			<header>
				<div style="display: flex; align-items: center">
					<a href="" class="upBtn but btnPush">
